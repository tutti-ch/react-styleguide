  ...
  776: function(e, t, n) {
    !(function(t, n) {
      ...
      function Display(e, t, r) {
        var i = this;
        (this.input = r),
          (i.scrollbarFiller = elt("div", null, "CodeMirror-scrollbar-filler")),
        ...
        if (e)
          for (var i = 0; i < e.length; ++i) {
            ...
            if (
              ...
              (r || (r = [])).push(new MarkedSpan(a, o.from, s ? null : o.to));
            }
          }
        return r;
      }
      ...
      function getBidiPartAt(e, t, n) {
        ...
        for (var i = 0; i < e.length; ++i) {
          ...
          o.to == t && (o.from != o.to && "before" == n ? (r = i) : (R = i)),
            o.from == t &&
              (o.from != o.to && "before" != n ? (r = i) : (R = i));
        }
        return null != r ? r : R;
      }
      ...
      function getContextBefore(e, t, n) {
        ...
        var o = findStartLine(e, t, n),
          ...
          s = a ? ee.fromSaved(r, a, o) : new ee(r, startState(r.mode), o);
        return (
      ...
      function takeToken(e, t, n, r) {
        ...
        for (r && (o = []); (r || u.pos < t.ch) && !u.eol(); )
          (u.start = u.pos),
            (i = readToken(s, u, c.state)),
            r && o.push(new te(u, i, copyState(a.mode, c.state)));
      ...
      function findStartLine(e, t, n) {
        for (
          ...
          if (
            c &&
            (!n || s + (c instanceof Q ? c.lookAhead : 0) <= o.modeFrontier)
          )
            return s;
      ...
      function retreatFrontier(e, t) {
        if (
          ...
          for (var n = e.first, r = t - 1; r > n; r--) {
            ...
            if (i && (!(i instanceof Q) || r + i.lookAhead < t)) {
              n = r + 1;
              break;
            }
          }
      ...
      function insertLineContent(e, t, n) {
        ...
        if (r)
          for (
            var a, s, l, c, u, d, p, h = i.length, f = 0, g = 1, m = "", v = 0;
            ;
        ...
        return (
          t.cache.hasOwnProperty(a)
            ...
            : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
              ...
              (o = measureCharInner(e, t, n, r)).bogus || (t.cache[a] = o)),
          {
            left: o.left,
            right: o.right,
            top: i ? o.rtop : o.top,
      ...
      function updateDisplayIfNeeded(e, t) {
        ...
        n.viewFrom < o &&
          ...
          z && ((o = visualLineNo(e.doc, o)), (a = visualLineEndNo(e.doc, a)));
        var s =
          o != n.viewFrom ||
          a != n.viewTo ||
      ...
      function onScrollWheel(e, t) {
        ...
        if ((i && c) || (o && u)) {
          ...
          if (i && !n && !d && null != ge)
            return (
              o && u && updateScrollTop(e, Math.max(0, s.scrollTop + o * ge)),
              setScrollLeft(e, Math.max(0, s.scrollLeft + i * ge)),
      ...
      function updateDoc(e, t, n, r) {
        ...
        function linesFor(e, t) {
          for (var n = [], i = e; i < t; ++i)
            n.push(new ne(a[i], spansFor(i), r));
          return n;
        }
        var i = t.from,
          o = t.to,
        ...
        if (t.full)
          ...
          if (1 == a.length)
            ...
            h.push(new ne(c + s.text.slice(o.ch), u, r)),
              ...
              var p = (function(n) {
                ...
                linkedDocs(e, function(e, t) {
                  t ||
                    ...
                    (rebaseHist(e.history, i), s.push(e.history)),
        ...
        for (var i = 0; i < e.length; ++i) {
          ...
          if (o.ranges) {
            ...
            for (var s = 0; s < o.ranges.length; s++)
              rebaseHistSelSingle(o.ranges[s].anchor, t, n, r),
      ...
      function dispatchKey(e, t, n, r) {
        ...
        return (
          ...
          i && !o && /\'$/.test(t) ? (e_preventDefault(n), !0) : !!o
        );
      }
        ...
        if (
          ...
          if (
            ...
            var r = posFromMouse(t, e),
              i = e_button(e),
              o = r ? clickRepeat(r, i) : "single";
            window.focus(),
              1 == i && t.state.selectingText && t.state.selectingText(e),
              (r && handleMappedButton(t, i, r, o, e)) ||
                (1 == i
                  ? r
                    ? leftButtonDown(t, r, o, e)
      ...
      function handleMappedButton(e, t, n, r, i) {
        ...
        return (
          ...
          dispatchKey(e, addModifierNames(o, i), i, function(t) {
      ...
      function leftButtonDown(e, t, n, r) {
        ...
        "single" == n &&
        (i = s.contains(t)) > -1 &&
        (cmp((i = s.ranges[i]).from(), t) < 0 || t.xRel > 0) &&
        (cmp(i.to(), t) > 0 || t.xRel < 0)
          ? leftButtonStartDrag(e, r, t, o)
          : leftButtonSelect(e, r, t, o);
      }
      function leftButtonStartDrag(e, t, n, r) {
        ...
        l && (i.scroller.draggable = !0),
          ...
          G(document, "mouseup", c),
          G(document, "mousemove", u),
          G(i.scroller, "dragstart", d),
          G(i.scroller, "drop", c),
          delayBlurEvent(e),
          setTimeout(function() {
      ...
      function leftButtonSelect(e, t, n, r) {
          ...
          if (0 != cmp(d, t))
            if (((d = t), "rectangle" == r.unit)) {
              for (
                var i = [],
                  c = e.options.tabSize,
                  u = countColumn(getLine(o, n.line).text, n.ch, c),
                  p = countColumn(getLine(o, t.line).text, t.ch, c),
                  h = Math.min(u, p),
                  f = Math.max(u, p),
                ...
                h == f
                  ...
                  : v.length > y &&
                    i.push(new ve(Pos(g, y), Pos(g, findColumn(v, f, c))));
              }
              i.length || i.push(new ve(n, n)),
                setSelection(
                  o,
                  normalizeSelection(l.ranges.slice(0, s).concat(i), s),
          ...
          if (a)
            if (0 != cmp(a, d)) {
              ...
              l &&
                setTimeout(
                  operation(e, function() {
                    h == n && ((i.scroller.scrollTop += l), extend(t));
                  }),
                  50
                );
            }
        ...
        if (
          (r.addNew && !r.extend
            ? ((s = o.sel.contains(n)), (a = s > -1 ? c[s] : new ve(n, n)))
        ...
        r.addNew
          ? -1 == s
            ? ((s = c.length),
              setSelection(o, normalizeSelection(c.concat([a]), s), {
                scroll: !1,
                origin: "*mouse"
              }))
            : c.length > 1 && c[s].empty() && "char" == r.unit && !r.extend
              ? (setSelection(
                ...
                (l = o.sel))
              : replaceOneSelection(o, s, a, H)
          : ((s = 0), setSelection(o, new me([a], 0), H), (l = o.sel));
        var d = n,
      ...
      function registerEventHandlers(e) {
        ...
        G(t.scroller, "touchstart", function(i) {
          ...
          G(t.scroller, "touchcancel", finishTouch),
        ...
        G(i, "keyup", function(t) {
          ...
          G(i, "keydown", operation(e, onKeyDown)),
          G(i, "keypress", operation(e, onKeyPress)),
          G(i, "focus", function(t) {
            return onFocus(e, t);
          }),
          G(i, "blur", function(t) {
            return onBlur(e, t);
      ...
      function indentLine(e, t, n, r) {
        ...
        if (r || /\S/.test(s.text)) {
          if (
            "smart" == n &&
            ((c = o.mode.indent(i, s.text.slice(u.length), s.text)) == N ||
              c > 150)
          ) {
            if (!r) return;
            n = "prev";
      ...
      function findPosV(e, t, n, r) {
        ...
        for (var c; (c = coordsChar(e, a, i)).outside; ) {
      ...
      function posToDOM(e, t) {
        ...
        var r = getLine(e.doc, t.line),
          ...
          a = "left";
        o && (a = getBidiPartAt(o, t.ch) % 2 ? "right" : "left");
      ...
      function domTextBetween(e, t, n, r, i) {
        ...
        for (var o = "", a = !1, s = e.doc.lineSeparator(); walk(t), t != n; )
          t = t.nextSibling;
        return o;
      }
      ...
      (Ge.prototype.init = function(e) {
        ...
        e.wrapper.insertBefore(i, e.wrapper.firstChild),
          ...
          G(o, "cut", prepareCopyCut),
          G(o, "copy", prepareCopyCut),
      ...
      return (
        ...
        (CodeMirror$1.fromTextArea = function fromTextArea(e, t) {
          ...
          if (
            e.form &&
            (G(e.form, "submit", save), !t.leaveSubmitMethodAlone)
          ) {
            var i = e.form;
            r = i.submit;
            try {
      ...
      a = (function(e) {
        function CodeMirror(e) {
          ...
          return (
            ...
            (t.initCb = function() {
              t.props.editorDidConfigure &&
                t.props.editorDidConfigure(t.editor);
            }),
            t
          );
        }
        return (
          _inherits(CodeMirror, i.default.Component),
          r(CodeMirror, [
            {
        ...
        function(t, n) {
          ...
          function xmlToken(n, o, a) {
            ...
            if ("{" == n.peek()) {
              ...
              return (
                (o.context = new Context(e.startState(i, s), i, 0, o.context)),
                null
              );
            }
            if (1 == a.depth) {
          ...
          if ("endTag" == e || "selfcloseTag" == e) {
            ...
            return (
              ...
              "selfcloseTag" == e || a.autoSelfClosers.hasOwnProperty(r)
                ? maybePopContext(n, r)
                : (maybePopContext(n, r),
                  (n.context = new Context(n, r, i == n.indented))),
              baseState
            );
          }
              ...
              return "vardef" == d
                ...
                : "form" == d && "{" == s
                  ...
                  : "form" == d
                    ? l.indented + o
                    : "stat" == d
                      ? l.indented + (isContinuedStatement(t, r) ? a || o : 0)
