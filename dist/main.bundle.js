(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["TuttiCH"] = factory();
	else
		root["TuttiCH"] = factory();
})(this, function() {
...
exports.Table = exports.Spinner = undefined;

var _Spinner2 = __webpack_require__(12);

var _Spinner3 = _interopRequireDefault(_Spinner2);

var _Table2 = __webpack_require__(19);
...
var Spinner = function (_Component) {
  ...
  function Spinner(props) {
    ...
    _this.calculateStyles = _this.calculateStyles.bind(_this);
    return _this;
  }
  ...
  _createClass(Spinner, [{
    ...
    value: function calculateStyles() {
      ...
      var thickness = size / 10;
      var border = thickness + 'rem solid rgba(' + rgba + ', ' + rgba + ', ' + rgba + ', ' + intensity + ')';
      var sizeInRem = size + 'rem';
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: (0, _classnames2.default)(_Spinner2.default.wrapper, className) },
        _react2.default.createElement('div', { className: _Spinner2.default.spinner, style: styles })
      );
    }
  }]);
...
Spinner.COLOR_LIGHT = 'light';
Spinner.COLOR_DARK = 'dark';
Spinner.SIZE_SMALL = 2;
Spinner.SIZE_MEDIUM = 5;
Spinner.SIZE_LARGE = 8;
Spinner.propTypes = {
  /**
   * Define the color of the spinner.
   */
  color: _propTypes2.default.oneOf([Spinner.COLOR_DARK, Spinner.COLOR_LIGHT]),
...
module.exports = {"title":"_2C5JZtGFBBE9Oyerc0UPmv","subtitle":"_2SrcGguovAFWGpjjpRp8Pg","wrapper":"_3DuxWIBKR1noQceD0yJd6s","spinner":"_3q8xbTG4aotRgd6r45oikk","spinMe":"_1chwDKWbG7L_JM91Gwfxky"};
...
var Table = function (_Component) {
  ...
  _createClass(Table, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'table',
        { className: (0, _classnames2.default)(className, _Table2.default.table) },
        children
      );
    }
  }]);
...
Table.propTypes = {
  ...
  className: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.object, _propTypes2.default.array])
};
...
// removed by extract-text-webpack-plugin
module.exports = {"title":"_13ixk0kJSm9uGSJvne79EJ","subtitle":"_3_Z6dyOYa87VS22qDXOPfq"};
