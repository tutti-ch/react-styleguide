...
export const SubscriptionsPlus = p => <Sprite {...p} viewBox="0 0 26.5 30" id="subscriptions-plus"/>
...
export const SubscriptionsProSupport = p => <Image {...p} src={require("./subscriptions-pro-support.svg")} />
export const SubscriptionsProWeb = p => <Image {...p} src={require("./subscriptions-pro-web.svg")} />
export const SubscriptionsPro = p => <Sprite {...p} viewBox="0 0 26.5 30" id="subscriptions-pro"/>
export const SubscriptionsReach = p => <Image {...p} src={require("./subscriptions-reach.svg")} />